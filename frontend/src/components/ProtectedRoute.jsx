    ...
    return (
      <div className="flex h-screen items-center justify-center bg-stone-50">
        <div className="flex flex-col items-center gap-3">
          <div className="h-12 w-12 animate-spin rounded-full border-4 border-wood-300 border-t-wood-600"></div>
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-stone-50 p-6">
        <div className="w-full max-w-md rounded-xl bg-white p-8 text-center shadow-lg border border-red-100">
          ...
          <h2 className="text-xl font-bold text-stone-850">Access Denied / ප්‍රවේශය ප්‍රතික්ෂේප කර ඇත</h2>
          <p className="mt-2 text-sm text-stone-500">
            Your user account ({user.role}) is not authorized to access this module. Contact the system administrator.
          </p>
          <a
            href="/"
            className="mt-6 inline-flex w-full justify-center rounded-lg bg-wood-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-wood-750 transition-colors"
          >
            Back to Dashboard / මුල් පිටුවට
          </a>
        </div>
      </div>
    );
